...
public class CodeGenerator {
    ...
    public static void main(String[] args) {
        ...
        gc.setAuthor("lujieni");
        gc.setOpen(false);
        gc.setIdType(IdType.AUTO);//设置主键为数据库自增
        ...
        pc.setParent("com.lujieni.mp.hello");
        pc.setMapper("dao");//mapper接口的包名
        ...
        */
        ...
        //strategy.setSuperEntityClass("com.lujieni.mp.common.BaseEntity");
